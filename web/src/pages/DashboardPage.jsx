...
import {
  ...
  CheckCircle2, AlertTriangle, TrendingUp, ArrowRight, PlusCircle, Network, BookOpen,
} from 'lucide-react'
...
const ACCESOS = [
  ...
  { to: '/casos', icon: BookOpen, color: '#EC0000', t: '30 Casos crédito', d: 'Practicar flujo móvil end-to-end' },
  { to: '/ecosistema', icon: Network, color: '#2563eb', t: 'Ecosistema', d: 'Conexiones BD, API y apps móviles' },
]
